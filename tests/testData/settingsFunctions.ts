 ...
 */
async function getNumeratorDenominator(
  locator: Locator,
 ...
 */
export async function checkFractionsEqual(
  page: Page,
  category: string,
): Promise<void> {
 ...
 */
export async function checkDeselectedAmount(
  page: Page,
  category: string,
  ...
  const { numerator, denominator } =
    await getNumeratorDenominator(fractionLocator);
 ...
 * @param category The category name to check (e.g. 'Bridges' or 'Exchanges')
 */
export async function checkNoneSelected(
  page: Page,
  category: string,
): Promise<void> {
  const fractionLocator = getFractionLocator(page, category);
