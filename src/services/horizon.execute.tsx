...
export class HorizonExecutionManager {
  ...
  executeCross = async (fromToken: Token, fromAmount: BigNumber, fromChainId: number, toChainId: number, destAddress: string, updateStatus?: Function, initialStatus?: Execution) => {
