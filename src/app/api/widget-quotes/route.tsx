...
// Test: http://localhost:3000/api/widget-quotes?fromToken=0x0000000000000000000000000000000000000000&fromChainId=137&toToken=0x0000000000000000000000000000000000000000&toChainId=42161&amount=10&highlighted=amount
...
export const WIDGET_IMAGE_HEIGHT = 656; //376;
    ...
    (
      ...
      >
        <img
          ...
          src={'http://localhost:3000/widget-quotes-light-compare.png'}
        />
        <WidgetQuoteSSR
