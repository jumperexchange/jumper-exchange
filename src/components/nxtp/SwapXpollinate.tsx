...
import { Alert, Badge, Button, Checkbox, Col, Collapse, Dropdown, Form, Input, Menu, Modal, Row , notification} from 'antd';
...
const SwapXpollinate = ({
  ...
  const handleActivateOption = () => {
    if (
      ...
      notification.open({ message: "Data Save Successfully" });
                ...
                <Collapse ghost>
                  <Collapse.Panel header={`Advanced Options`} key="1">
                    ...
                    />
                     <Row style={{ marginTop: 24 }} justify={"center"}>
                       {/* {submitButton()} */}
                      <Button shape="round" type="primary"onClick={(e) => handleActivateOption()} >
                        Submit
                      </Button>
                     </Row>
                  </Collapse.Panel>
