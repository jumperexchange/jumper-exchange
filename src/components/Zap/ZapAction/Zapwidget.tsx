...
import {
  refuelAllowChains,
  themeAllowChains,
} from 'src/components/Widgets/Widget.types';
...
export function ZapWidget({
  ...
  const overriddenTheme = {
    ...
    container: {
      ...widgetTheme.config.theme?.container,
      boxShadow: 'unset',
      '@media (min-width:600px)': {
        // @ts-ignore or @ts-expect-error
        ...widgetTheme.config.theme?.container['@media (min-width:600px)'],
        boxShadow: 'unset',
      },
    },
  };

  // Update the widgetTheme.config.theme with the new overridden theme
  const updatedWidgetTheme = {
    ...widgetTheme,
    config: {
      ...widgetTheme.config,
  ...
  const config: WidgetConfig = useMemo((): WidgetConfig => {
    ...
    return {
      ...
      theme: updatedWidgetTheme.config.theme,
    ...
    updatedWidgetTheme.config.theme,
    multisigWidget,
    isMultisigSigner,
    multisigSdkConfig,
