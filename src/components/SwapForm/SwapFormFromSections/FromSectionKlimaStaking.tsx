...
interface FromSectionKlimaStakingProps {
  className?: string
...
export const FromSectionKlimaStaking = (props: FromSectionKlimaStakingProps) => {
    ...
    <>
      <>
        <Row style={{ marginBottom: 8 }}>
          <Col span={10}>
            <div className="form-text">Get sKlima With:</div>
          </Col>
        </Row>
          ...
          <Col span={24}>
            <div className="form-input-wrapper">
              <Input
                ...
                placeholder="Enter amount of sKlima to receive"
                bordered={false}
              />
            </div>
          </Col>
