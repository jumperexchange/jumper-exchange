...
function BerachainTransactionDetails({ market }: { market: EnrichedMarketDataType }) {
  ...
  return (
    <Box>
      <Button variant="text" onClick={() => setOpen(!open)}>Transaction Details</Button>
      <Collapse in={open}>
         ...
         */}
        {market.market_type === RoycoMarketType.recipe.id && (
          <InfoCard.Row>
          ...
          <InfoCard.Row>
            ...
            <InfoCard.Row.Value>
              ...
              {Intl.NumberFormat('en-US', {
                ...
                market.total_incentive_amounts_usd ?? 0,
              )}
              <Tooltip
                title={market.market_type === RoycoMarketType.recipe.id
        ...
        <InfoCard.Row>
          ...
          <InfoCard.Row.Value>
            ...
            >
              {
                // @ts-ignore
                market.input_token_data.contract_address.slice(
                  0,
                  6,
                ) +
                '...' +
