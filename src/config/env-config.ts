...
const clientBuildTimeEnv: RuntimeConfig = {
  ...
  NEXT_PUBLIC_SOLANA_SEND_RPC_URLS:
    process.env.NEXT_PUBLIC_SOLANA_SEND_RPC_URLS ?? '',
  NEXT_PUBLIC_SOLANA_SEND_JITO_RPC_URLS:
    process.env.NEXT_PUBLIC_SOLANA_SEND_JITO_RPC_URLS ?? '',
