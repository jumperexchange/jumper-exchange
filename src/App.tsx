              ...
              <Row>
                ...
                <Col xs={0} sm={0} md={10} lg={10} xl={10} style={{ paddingRight: 10 }}>
                  <Row justify="end" gutter={15}>
                    <Col>
                      <a className="headerIconLink" href="https://twitter.com/lifiprotocol" target="_blank" rel="nofollow noreferrer">
                        <TwitterOutlined />
                      </a>
                    </Col>
                    <Col>
                      <a className="headerIconLink" href="https://github.com/lifinance" target="_blank" rel="nofollow noreferrer">
                        <GithubOutlined />
                      </a>
                    </Col>
                    <Col>
