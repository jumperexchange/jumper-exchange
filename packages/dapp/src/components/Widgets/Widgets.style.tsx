...
export const WidgetContainer = styled(Box, {
  ...
  ({ theme, isActive, welcomeScreenHover, welcomeScreenClosed }) => ({
    display: isActive ? 'inherit' : 'none',
    margin: '0 auto 24px',

    '& > .widget-wrapper > div, & > .onramper-wrapper': {
      overflow: 'hidden',
      paddingTop: welcomeScreenHover
        ? 0
        : !welcomeScreenClosed
        ? theme.spacing(3)
        : theme.spacing(3.5),
      transitionProperty: !welcomeScreenClosed && 'padding-top',
      transitionDuration: !welcomeScreenClosed && '.3s',
      transitionTimingFunction: !welcomeScreenClosed && 'ease-in-out',
      ...
      [`@media screen and (min-height: 700px)`]: {
        marginTop: !welcomeScreenClosed
          ...
          : '0', // (mid viewheight - half-two/thirds widget height - header height )
      },
